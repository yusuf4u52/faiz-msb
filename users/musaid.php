	...
	<div class="container">
		<table class="table table-hover">
			...
			<tbody>
				...
				$result = mysqli_query($link, "SELECT id, Thali, Name, ITS_No, contact, fathersNo, yearly_hub, total_pending, Previous_Due, Paid, thalicount, WhatsApp FROM thalilist where total_pending > 0 and musaid='" . $_SESSION['email'] . "'");
