...
if($_GET)
{
    $query="SELECT id, Thali, NAME, CONTACT, Active, Transporter, thalicount, Full_Address, Thali_start_date, Thali_stop_date, (Previous_Due + Dues + yearly_hub + Zabihat + Reg_Fee + TranspFee - Paid) AS Total_Pending FROM thalilist";
