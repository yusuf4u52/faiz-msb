...
$update = mysqli_query($link,"UPDATE thalilist set Thali_stop_date='" . $_POST['stop_date'] . "' WHERE id = '".$_SESSION['thaliid']."'") or die(mysqli_error($link));
...
mysqli_query($link,"INSERT INTO change_table (`Thali`, `userid`,`Operation`, `Date`) VALUES ('" . $_SESSION['thali'] . "','".$_SESSION['thaliid']."', 'Stop Thali','" . $_POST['stop_date'] . "')") or die(mysqli_error($link));
