...
if ($count == 0) {
  ...
  mysqli_query($link,"update change_table set processed = 1 where Thali = '" . $_POST['thaali_id'] . "' and `Operation` in ('Start Thali','Stop Thali','Start Transport','Stop Transport') and processed = 0");
