...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="row"><a href='selectyearlyhub_action.php?option=2' class="col-xs-12 col-sm-10 col-md-6 col-lg-4 btn btn-primary" style='margin:5px'>24,000/-</a></div>
        <div class="row"><a href='selectyearlyhub_action.php?option=3' class="col-xs-12 col-sm-10 col-md-6 col-lg-4 btn btn-primary" style='margin:5px'>27,000/-</a></div>
        ...
        <div class="row" id="contactNumbers" style="display:none">
          ...
          <address class="col-6">
            <strong>M Murtaza Shabbir bhai Rampurawala</strong>
            <br> murtaza52@gmail.com
            <br>
            <strong> 9923109052</strong>
          </address>
          <address class="col-6">
