...
function stopThali_admin(thaaliId, active, hardStop, hardStopComment, successCallback, failureCallback) {
  ...
  $.ajax({
    ...
    success: function(data) {
      if (data == 'success') {
        ...
        alert('Something went wrong while stopping thaali #' + thaaliId + '. Please contact Mustafa Manawar or Yusuf Rampur');
      }
      if (successCallback) {
