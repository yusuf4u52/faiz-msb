...
if (mysqli_num_rows($result) == 0) {
	mysqli_query($link, "INSERT INTO event_response (`reference_id`,`thaliid`,`eventid`,`response`,`its`,`name`,`mobile`) VALUES ('".$_POST['reference_id']."','','".$_POST['eventid']."','yes','".$_POST['its']."','".$_POST['name']."','".$_POST['mobile']."')") or die(mysqli_error($link));
