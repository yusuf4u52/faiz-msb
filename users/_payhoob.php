...
$result = file_get_contents("https://sms1.almasaarr.com/sendhttp.php?authkey=$smsauthkey&mobiles=$sms_to&message=$sms_body_encoded&sender=FAIZST&route=Template");
